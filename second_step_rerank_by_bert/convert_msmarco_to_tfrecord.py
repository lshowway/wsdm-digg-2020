...
def convert_eval_dataset(set_name, tokenizer):
    ...
    for i, line in enumerate(f):
      ...
      if set_name == 'dev':
        if '\t'.join([query_id, doc_id]) in relevant_pairs:
          label = 1
      #queries_docs[query].append((doc_id, doc, label))         # changed by junfeng.
      queries_docs[query_id].append((query, doc_id, doc, label))
  ...
  with open(query_doc_ids_path, 'w') as ids_file:
    ...
    for i, (query_id, doc_ids_docs) in enumerate(queries_docs.items()):
      #doc_ids, docs, labels = zip(*doc_ids_docs)
      query, doc_ids, docs, labels = zip(*doc_ids_docs)
...
'''
python3 convert_msmarco_to_tfrecord.py \
  --output_folder=/home/LAB/liujf/datasets/bert_tfrecord_1_4_50/  \
  --vocab_file=/home/LAB/zhaoqh/workspace/CitationIntent/uncased_L-12_H-768_A-12/vocab.txt \
  --train_dataset_path=/home/LAB/zhaoqh/ljf/datasets/triples.train-key-sentence-remove-dev.tsv \
  --dev_dataset_path=/home/LAB/liujf/datasets/bert_input_1_4_50/top50.dev.tsv \
  --eval_dataset_path=/home/LAB/liujf/datasets/bert_input_1_4_50/top50.evl.tsv \
  --dev_qrels_path=/home/LAB/liujf/datasets/bert_input_1_4_50/qrel.dev.tsv \
  --max_query_length=128 \
  --max_seq_length=512 \
  --num_eval_docs=50
  
python3 convert_msmarco_to_tfrecord.py \
  --output_folder=/home/LAB/zhaoqh/ljf/datasets/bert_tfrecord_1_4/  \
  --vocab_file=/home/LAB/zhaoqh/workspace/CitationIntent/uncased_L-12_H-768_A-12/vocab.txt \
  --train_dataset_path=/home/LAB/zhaoqh/ljf/datasets/bert_input_1_4/triples.train-key-sentence-remove-dev.tsv  \
  --dev_dataset_path=/home/LAB/liujf/datasets/top50.dev.tsv \
  --eval_dataset_path=/home/LAB/liujf/datasets/top50.evl.tsv \
  --dev_qrels_path=/home/LAB/liujf/datasets/qrel.dev.tsv \
  --max_query_length=128 \
  --max_seq_length=512 \
  --num_eval_docs=50
...
python3 convert_msmarco_to_tfrecord.py \
  --output_folder=/home/LAB/zhaoqh/ljf/datasets/bert_tfrecord_1_19/  \
  --vocab_file=/home/LAB/zhaoqh/workspace/CitationIntent/uncased_L-12_H-768_A-12/vocab.txt \
  --train_dataset_path=/home/LAB/zhaoqh/ljf/datasets/bert_input_1_19/triples.train-key-sentence-remove-dev.tsv  \
  --dev_dataset_path=/home/LAB/zhaoqh/ljf/datasets/bert_input_1_19/top100.dev.tsv \
  --eval_dataset_path=/home/LAB/zhaoqh/ljf/datasets/bert_input_1_19/top100.evl.tsv \
  --dev_qrels_path=/home/LAB/zhaoqh/ljf/datasets/bert_input_1_19/qrel.dev.tsv \
  --max_query_length=128 \
  --max_seq_length=512 \
  --num_eval_docs=100
